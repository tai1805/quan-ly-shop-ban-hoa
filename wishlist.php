...
if(isset($_GET['delete'])){
   // (lấy thông tin sản phẩm cần xóa và thực hiện xóa)
...
if(isset($_GET['delete_all'])){
   //(xóa toàn bộ sản phẩm trong danh sách yêu thích)
...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      <a href="wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times" onclick="return confirm('Xóa khỏi danh sách?');"></a>
   ...
   <?php
      ...
      echo '<p class="empty">Danh sách yêu tích của bạn đang trống!</p>';
   }
   ?>
   </div>

   <div class="wishlist-total">
      <!-- Hiển thị tổng cộng và các nút tương tác -->
