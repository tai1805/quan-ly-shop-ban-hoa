...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="price" min="0" placeholder="Nhập giá sản phẩm" required class="box" value="<?= $fetch_products['price']; ?>">
      <input type="number" name="quantity" min="0" placeholder="Nhập số lượng sản phẩm" required class="box" value="<?= $fetch_products['quantity']; ?>">
      ...
      <textarea name="details" required placeholder="Nhập mô tả sản phẩm" class="box" cols="30" rows="10"><?= $fetch_products['details']; ?></textarea>
      <input type="file" name="image" class="box" accept="image/jpg, image/jpeg, image/png">
      <div class="flex-btn">
         <input type="submit" class="btn" value="Cập nhật sản phẩm" name="update_product">
